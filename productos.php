                        ...
                        <?php while ($producto = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    if (!empty($imagen)):
                                        $ruta_imagen = "../imagenes/" . htmlspecialchars($imagen);
                                        $version = file_exists($ruta_imagen) ? filemtime($ruta_imagen) : time();
                                    ?>
                                        <img src="<?= $ruta_imagen . '?v=' . $version; ?>" 
                                ...
                                <td>
                                    <a class="btn" href="editar_productos.php?id=<?= (int)$producto['id_producto']; ?>">Editar</a>
                                    <a class="btn" href="eliminar_prodctos.php?id=<?= (int)$producto['id_producto']; ?>"
